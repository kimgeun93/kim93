...
var Bta = function (_React$Component) {
   _inherits(Bta, _React$Component);

   function Bta() {
      _classCallCheck(this, Bta);

      return _possibleConstructorReturn(this, (Bta.__proto__ || Object.getPrototypeOf(Bta)).apply(this, arguments));
   }
...
_reactDom2.default.render(_react2.default.createElement(Bta, null), document.getElementById('app'));
